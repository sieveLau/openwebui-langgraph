...
def search_local_knowledge(query: Annotated[str, "Keywords to search the database"]) -> str:
...
""".format(i, doc.metadata['title'], doc.metadata['source'], doc.metadata['add_date'], doc.page_content)
    return constructor